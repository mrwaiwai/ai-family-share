...
const knowledgeItemsZh: KnowledgeItem[] = [
  ...
  },
  {
    icon: Wrench,
    title: "認識不同的 AI 工具",
    description: "以下按用途重新分類常見 AI 工具，聚焦香港可直接使用的選項，方便家長按情境選擇。",
    tag: "工具介紹",
    category: "入門認識",
    accent: "bg-soft-pink",
    details: [
      "對話與寫作類：ChatGPT、Claude、Gemini、Perplexity，適合問答、改寫、摘要、翻譯、腦力激盪。",
      "搜尋與研究類：Perplexity、Gemini（含網頁查詢）、ChatGPT（含瀏覽功能），適合找來源、做資料比對與重點整理。",
      "學習與理科推理類：DeepSeek、ChatGPT、Gemini、Kimi、通義千問，常用於數學步驟講解、概念拆解、題目變式練習。",
      "辦公與生產力類：Microsoft Copilot、Notion AI、Canva Magic Write，可用於電郵草稿、會議摘要、簡報與文案。",
      "中國常見綜合助手：豆包（Doubao）、文心一言、通義千問、Kimi、訊飛星火，常見於中文寫作、知識問答、學習整理與日常工作。",
      "圖像生成類：DALL-E、Midjourney、Adobe Firefly、Stable Diffusion，適合教材插圖、活動海報、視覺草圖。",
      "影片與語音類：CapCut AI、Runway、Pika、ElevenLabs，常見於短片製作、字幕整理、旁白配音。",
      "開源／本地部署類：Llama、Mistral、Stable Diffusion（本地版），適合重視資料私隱或希望離線測試的家庭。",
      "香港使用提醒：以上大部分工具可在香港以網頁或 App 使用；部分進階功能需付費或需國際信用卡訂閱。",
    ],
    keyPoints: [
      { label: "分類方式", value: "對話寫作 / 研究搜尋 / 生產力 / 圖像影片 / 本地部署" },
      { label: "香港可用", value: "多數可直接使用，部分功能受方案與地區政策影響" },
      { label: "選擇原則", value: "先按任務類型選工具，再比較輸出質素與私隱設定" },
    ],
  },
  {
    icon: BookOpen,
...
const knowledgeItemsEn: KnowledgeItem[] = [
  ...
  },
  {
    ...
    description: "This section reorganizes common tools by use case, with a focus on options accessible in Hong Kong.",
    tag: "Tool Guide",
    category: "Foundations",
    accent: "bg-soft-pink",
    details: [
      "Chat and writing tools: ChatGPT, Claude, Gemini, Perplexity for drafting, summarizing, rewriting, translating, and brainstorming.",
      "Search and research tools: Perplexity, Gemini (web-connected), ChatGPT (with browsing) for source checking and topic comparison.",
      "Learning and STEM reasoning tools: DeepSeek, ChatGPT, Gemini, Kimi, Tongyi Qianwen for step-by-step explanation and concept practice.",
      "Productivity tools: Microsoft Copilot, Notion AI, Canva Magic Write for email drafts, meeting notes, slides, and copywriting.",
      "Mainland China general assistants: Doubao, ERNIE Bot, Tongyi Qianwen, Kimi, and Xunfei Spark, commonly used for Chinese writing, Q&A, and daily productivity.",
      "Image generation tools: DALL-E, Midjourney, Adobe Firefly, Stable Diffusion for teaching visuals and creative mockups.",
      "Video and voice tools: CapCut AI, Runway, Pika, ElevenLabs for short clips, subtitles, and narration.",
      "Open-source/local options: Llama, Mistral, Stable Diffusion (local setup) for families prioritizing privacy and offline testing.",
      "Hong Kong access note: most tools above are usable via web or app in Hong Kong; some advanced features require paid plans.",
    ],
    keyPoints: [
      { label: "Grouping logic", value: "Chat/Writing, Research, Productivity, Image/Video, Local Models" },
      { label: "HK availability", value: "Mostly available, but feature access depends on plan and regional policy" },
      { label: "How to choose", value: "Start from task type, then compare output quality and privacy settings" },
    ],
  },
  {
    icon: BookOpen,
